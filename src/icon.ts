export const languages = {
  ...
  cloudfoundrymanifest: { ids: 'yaml', defaultExtension: 'yml' },
  ...
  dockercompose: { ids: 'yaml', defaultExtension: 'yml' },
  ...
  javascript: { ids: 'js', defaultExtension: 'js' },
  javascriptreact: { ids: 'reactjs', defaultExtension: 'jsx' },
  ...
  csproj: { ids: 'sln', defaultExtension: 'csproj' },
  png: { ids: 'image', defaultExtension: 'png' },
  jpg: { ids: 'image', defaultExtension: 'jpg' },
  jpeg: { ids: 'image', defaultExtension: 'jpeg' },
  gif: { ids: 'image', defaultExtension: 'gif' },
  bmp: { ids: 'image', defaultExtension: 'bmp' },
  svgz: { ids: 'image', defaultExtension: 'svgz' },
  tiff: { ids: 'image', defaultExtension: 'tiff' },
  tif: { ids: 'image', defaultExtension: 'tif' },
  webp: { ids: 'image', defaultExtension: 'webp' },
  ico: { ids: 'image', defaultExtension: 'ico' },
  ...
  typescriptreact: { ids: 'reactjs', defaultExtension: 'tsx' },
  ...
  tff: { ids: 'font', defaultExtension: 'tff' },
  otf: { ids: 'font', defaultExtension: 'otf' },
  woff: { ids: 'font', defaultExtension: 'woff' },
  woff2: { ids: 'font', defaultExtension: 'woff2' },
  eot: { ids: 'font', defaultExtension: 'eot' },
  pdf: { ids: 'pdf', defaultExtension: 'pdf' },
};